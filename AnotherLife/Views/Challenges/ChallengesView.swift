...
struct ChallengesView: View {
    ...
    @State private var scrollToUserID: String? = nil
                ...
                if showingJoinSuccessAlert {
                    LuxuryJoinSuccessAlert(
                        ...
                        onAwesomeButtonTapped: {
                            // Navigate to "My Challenges" tab smoothly
    ...
    private var leaderboardView: some View {
        ScrollViewReader { proxy in
                    ...
                    if leaderboardManager.isLoading {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            HStack {
                                ...
                                // Scroll to user button (only show if user is not in top 5 and exists in leaderboard)
                                if let currentUserId = authManager.currentUser?.id,
                                   !leaderboardManager.topUsers.isEmpty,
                                   leaderboardManager.topUsers.contains(where: { $0.id == currentUserId }),
                                   !leaderboardManager.topUsers.prefix(5).contains(where: { $0.id == currentUserId }),
                                   leaderboardManager.currentUserRank > 0 {
                                    Button(action: {
                                        // Scroll to user's position
                                        scrollToUserID = currentUserId
                                    }) {
                                        HStack(spacing: 6) {
            ...
            .onChange(of: scrollToUserID) { oldValue, newValue in
                if let userID = newValue {
                    // Scroll to user's position in leaderboard
                    withAnimation(.easeInOut(duration: 0.8)) {
                        proxy.scrollTo("player_\(userID)", anchor: .center)
                    }
    ...
    struct ChallengeCardView: View {
        ...
        var body: some View {
            ...
            .fullScreenCover(isPresented: $showingDetail) {
                ChallengeDetailView(
                    challenge: challenge,
                    onJoinSuccessNavigate: onJoinSuccessNavigate,
                    selectedTabBinding: selectedTabBinding,
                    onJoinSuccess: { message in
                        // Show the alert in the parent view after detail view is dismissed
            ...
            .onChange(of: progress?.currentValue) { oldValue, newValue in
                // Refresh daily status when progress changes
                loadTodayStatus()
            }
            .onChange(of: progress?.lastUpdatedAt) { oldValue, newValue in
    ...
    struct LeaderboardRowView: View {
                ...
                HStack(spacing: 12) {
                    ...
                    ZStack {
                        ...
                        Circle()
                            ...
                            .frame(width: 48, height: 48)
                            .shadow(color: isCurrentUser ? Color.primaryBlue.opacity(0.5) : .clear, radius: 12, x: 0, y: 6)
                            .overlay(
                                // Additional border for current user
                                isCurrentUser ?
                                Circle()
                                    .stroke(
                                        LinearGradient(
            ...
            .background(
                ZStack {
                    ...
                    if rank <= 3 {
                        ...
                        // Current user styling (if not in top 3) - Enhanced to stand out more
                        LinearGradient(
                            gradient: Gradient(colors: [
        ...
        private var playerTextColor: Color {
            if rank <= 3 {
                ...
                return .white // Make current user text white for better contrast
            } else {
                return .textPrimary
            }
        }
        ...
        private var usernameTextColor: Color {
            if rank <= 3 {
                ...
                return .white.opacity(0.7) // Make current user username lighter for better contrast
            } else {
        ...
        private var shadowColor: Color {
            ...
            default: return isCurrentUser ? Color.primaryBlue.opacity(0.3) : Color.black.opacity(0.05)
            }
        }
        ...
        private var shadowRadius: CGFloat {
            ...
            case 2: return 12
            case 3: return 10
            default: return isCurrentUser ? 15 : 6 // Enhanced shadow for current user
            }
        }
        ...
        private var shadowY: CGFloat {
            ...
            case 2: return 6
            case 3: return 5
            default: return isCurrentUser ? 8 : 3 // Enhanced shadow for current user
            }
        }
    }
